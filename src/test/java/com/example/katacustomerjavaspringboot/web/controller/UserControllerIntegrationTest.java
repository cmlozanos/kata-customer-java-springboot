...
class UserControllerIntegrationTest {
	...
	void givenRequestWithoutAuthenticationWhenAddResourceThenShouldReturnForbidden() {
		...
		RestAssuredMockMvc
				...
				.postProcessors(SecurityMockMvcRequestPostProcessors.httpBasic("invalid", "invalidpwd")).body(user)
	...
	void givenUserIdRequestWhenFindByIdResourceThenShouldReturnUser() {
		...
		final String location = RestAssuredMockMvc.given().mockMvc(this.mockMvc)
				.postProcessors(SecurityMockMvcRequestPostProcessors.httpBasic("katauser", "katapassword")).body(user)
